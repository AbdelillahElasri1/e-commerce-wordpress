...
class best_shop_product_slider_widget extends WC_Widget {

function __construct() {
		
      $this->widget_cssclass    = 'woocommerce best_shop_product_slider_widget';
      $this->widget_description = __( 'Display Product Slider.', 'best-shop' );
      $this->widget_id          = 'best_shop_product_slider_widget';
      $this->widget_name        = __( '+ Product Slider', 'best-shop' );
...
public function widget( $args, $instance ) {
      ...
      //carousal begin
      echo '<div id="'.esc_attr($carousal_id).'" class="product-slider carousel slide " data-ride="carousel" data-interval="'.esc_attr($speed*1000).'" >';
...
public function form( $instance ) {
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title_price' )); ?>"><?php esc_html_e( 'Hide Title and Price','best-shop' ); ?></label> 
		</p>
...
function best_shop_product_slider_widget() {
		register_widget( 'best_shop_product_slider_widget' );
}
add_action( 'widgets_init', 'best_shop_product_slider_widget' );