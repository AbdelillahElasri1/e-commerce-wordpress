...
if( ! class_exists( 'best_shop_Control_Repeater' ) ) {
    ...
    class best_shop_Control_Repeater extends WP_Customize_Control {
    	...
    	public function enqueue() {    
            ...
            wp_enqueue_script( 'best-shop-repeater', get_template_directory_uri() . '/inc/controlset/repeater/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
    		wp_enqueue_style( 'best-shop-repeater', get_template_directory_uri() . '/inc/controlset/repeater/repeater.css', null );
    	}
